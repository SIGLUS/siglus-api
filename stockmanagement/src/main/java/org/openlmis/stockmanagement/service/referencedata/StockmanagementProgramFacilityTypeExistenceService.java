...
@Component
public class StockmanagementProgramFacilityTypeExistenceService {

  @Autowired
  private StockmanagementProgramReferenceDataService programReferenceDataService;

  @Autowired
  private StockmanagementFacilityTypeReferenceDataService facilityTypeReferenceDataService;
