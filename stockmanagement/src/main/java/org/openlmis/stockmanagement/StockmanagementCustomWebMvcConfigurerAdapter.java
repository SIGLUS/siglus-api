...
import org.openlmis.stockmanagement.interceptor.StockmanagementMvcInterceptor;
...
@Configuration
public class StockmanagementCustomWebMvcConfigurerAdapter extends WebMvcConfigurerAdapter {

  @Value("${service.url}")
  private String serviceUrl;

  @Autowired
  private StockmanagementMvcInterceptor mvcInterceptor;
