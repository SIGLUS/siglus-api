...
public class StockmanagementProgramFacilityTypeExistenceServiceTest {
  @InjectMocks
  StockmanagementProgramFacilityTypeExistenceService programFacilityTypeExistenceService;

  @Mock
  StockmanagementProgramReferenceDataService programRefDataService;

  @Mock
  StockmanagementFacilityTypeReferenceDataService facilityTypeRefDataService;
