...
import static org.openlmis.stockmanagement.service.referencedata.StockmanagementSupervisoryNodeReferenceDataService.FACILITY_ID;
import static org.openlmis.stockmanagement.service.referencedata.StockmanagementSupervisoryNodeReferenceDataService.PROGRAM_ID;
...
public class StockmanagementSupervisoryNodeReferenceDataServiceTest {
  ...
  private StockmanagementSupervisoryNodeReferenceDataService spy;

  @Before
  public void setUp() {
    supervisoryNode.setId(UUID.randomUUID());
    spy = spy(new StockmanagementSupervisoryNodeReferenceDataService());
  }
