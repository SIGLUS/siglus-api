...
public class StockmanagementLotReferenceDataServiceTest extends
    BaseReferenceDataServiceTest<LotDto> {

  private StockmanagementLotReferenceDataService service;

  @Override
  protected BaseReferenceDataService<LotDto> getService() {
    return new StockmanagementLotReferenceDataService();
  }
  ...
  public void setUp() throws Exception {
    ...
    service = (StockmanagementLotReferenceDataService) prepareService();
  }
