...
public class StockmanagementApprovedProductReferenceDataServiceTest
    extends BaseReferenceDataServiceTest<ApprovedProductDto> {

  private StockmanagementApprovedProductReferenceDataService service;

  @Override
  protected BaseCommunicationService<ApprovedProductDto> getService() {
    return new StockmanagementApprovedProductReferenceDataService();
  }
  ...
  public void setUp() throws Exception {
    super.setUp();
    service = (StockmanagementApprovedProductReferenceDataService) prepareService();
  }
