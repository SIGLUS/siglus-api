...
public class StockmanagementSupervisingUsersReferenceDataServiceTest
    extends BaseReferenceDataServiceTest<UserDto> {

  private StockmanagementSupervisingUsersReferenceDataService service;
  ...
  public void setUp() throws Exception {
    super.setUp();
    service = (StockmanagementSupervisingUsersReferenceDataService) prepareService();
  }
  ...
  protected BaseCommunicationService<UserDto> getService() {
    return new StockmanagementSupervisingUsersReferenceDataService();
  }
