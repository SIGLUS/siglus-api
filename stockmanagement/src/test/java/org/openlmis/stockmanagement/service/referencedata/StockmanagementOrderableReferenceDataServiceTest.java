...
public class StockmanagementOrderableReferenceDataServiceTest extends
    BaseReferenceDataServiceTest<OrderableDto> {

  private StockmanagementOrderableReferenceDataService service;

  @Override
  protected BaseReferenceDataService<OrderableDto> getService() {
    return new StockmanagementOrderableReferenceDataService();
  }
  ...
  public void setUp() throws Exception {
    ...
    service = (StockmanagementOrderableReferenceDataService) prepareService();
  }
