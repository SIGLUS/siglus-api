 ...
 */
public class ReferencedataJaVersDateProvider implements DateProvider {
  public static final org.joda.time.DateTimeZone DATE_TIME_ZONE = org.joda.time.DateTimeZone.UTC;
  ...
  public static ZonedDateTime getZonedDateTime(LocalDateTime localDateTime) {
    ...
    /* Get an instant representing localDateTime with the understanding that it was stored
       using ReferencedataJaVersDateProvider.DATE_TIME_ZONE */
