...
import org.openlmis.referencedata.interceptor.ReferencedataMvcInterceptor;
...
@Configuration
public class ReferencedataCustomWebMvcConfigurerAdapter extends WebMvcConfigurerAdapter {

  @Value("${service.url}")
  private String serviceUrl;

  @Autowired
  private ReferencedataMvcInterceptor mvcInterceptor;
