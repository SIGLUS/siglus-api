...
@Slf4j
@Service
public class TravRequisitionReportServiceService implements IRequisitionReportService {
  ...
  public InputStream getTemplateFile() {
    return getClass().getResourceAsStream("/static/requisition/TRAV_pt.xlsx");
  }
