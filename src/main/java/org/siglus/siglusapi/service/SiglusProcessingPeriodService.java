...
public class SiglusProcessingPeriodService {
  ...
  private void setSubmitStartAndEndDate(ProcessingPeriodDto periodDto, String facilityTypeCode) {
    ...
    submitStartDate = LocalDate.of(periodDto.getEndDate().getYear(), periodDto.getEndDate().getMonthValue(), 5);
    submitEndDate = LocalDate.of(periodDto.getEndDate().getYear(), periodDto.getEndDate().getMonthValue(), 12);
