...
@Builder
@EventPayload
public class AndroidProofOfDeliverySyncedEvent {

  private UUID userId;
  private PodRequest request;

  public AndroidProofOfDeliverySyncedEvent(UUID userId, PodRequest request) {
    this.userId = userId;
    this.request = request;
  }

  public AndroidProofOfDeliverySyncedEvent() {
  }
}
