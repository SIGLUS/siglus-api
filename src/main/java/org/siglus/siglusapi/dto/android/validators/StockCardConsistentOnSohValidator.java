...
@Slf4j
public class StockCardConsistentOnSohValidator implements
    ConstraintValidator<StockCardConsistentOnSoh, List<StockCardCreateRequest>> {

  @Override
  public void initialize(StockCardConsistentOnSoh constraintAnnotation) {
    // nothing to do
  }
