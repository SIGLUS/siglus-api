...
@ToString
@Getter
public class MovementRawDetail {
  ...
  private MovementRawDetail(Integer adjustment, MovementType type, @Nullable String reason) {
  ...
  private static MovementRawDetail of(Integer unsignedAdjustment, String sourceName, String sourceFacilityName,
    ...
    return new MovementRawDetail(adjustment, movementType, reason);
  }

  public MovementRawDetail merge(MovementRawDetail movementDetail) {
    ...
    return new MovementRawDetail(mergedAdjustment, type, mergedReason);
  }

  public MovementDetail toMovementDetail() {
    return new MovementDetail(adjustment, type, reason == null ? null : type.getReason(reason, adjustment));
  }
