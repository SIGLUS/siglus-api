...
@NamedNativeQueries({
    @NamedNativeQuery(name = "LocationMovement.getStockMovementWithLocation",
        query = "select\n"
            ...
            + "    and scli.reasonid is not null then sclir.name\n"
            + "    when sclir2.\"name\" is not null then sclir2.\"name\"\n"
            + "    when scli.sourceid is null\n"
            + "    and scli.destinationid is null\n"
            ...
            + "    when scli.sourceid is null\n"
            + "    and scli.destinationid is null\n"
            + "    and scli.reasonid is null then pili.quantity-pili.previousstockonhandwhensubmitted\n"
            + "    else scli.quantity\n"
            + "  end as quantity ,\n"
            + "  scli.occurreddate ,\n"
            + "  scli.processeddate ,\n"
