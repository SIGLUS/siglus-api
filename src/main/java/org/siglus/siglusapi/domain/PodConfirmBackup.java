...
@Table(name = "pod_confirm_backup", schema = "siglusintegration")
public class PodConfirmBackup extends BaseEntity {

  private String orderNumber;

  private UUID facilityId;

  @Column(name = "oldpod", columnDefinition = "jsonb")
  @Convert(converter = PodResponseConverter.class)
