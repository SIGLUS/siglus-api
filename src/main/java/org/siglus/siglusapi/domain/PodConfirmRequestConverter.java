...
@Slf4j
public class PodConfirmRequestConverter implements AttributeConverter<PodRequest, String> {
  ...
  public PodConfirmRequestConverter() {
  ...
  PodConfirmRequestConverter(ObjectMapper objectMapper) {
  ...
  public String convertToDatabaseColumn(@NotNull PodRequest request) {
    try {
      ...
      log.error("Can't convert podconfirm request to database column", ex);
      return null;
    }
  }
  ...
  public PodRequest convertToEntityAttribute(@NotNull String requestAsString) {
    ...
    try {
      ...
      log.error("Can't convert string to pod confirm request", ex);
      return new PodRequest();
    }
  }
}
