...
@RestController
@RequestMapping("/api/siglusapi/movementDateLimit")
public class SiglusMovementDateLimitController {

  private final MovementDateValidator movementDateValidator;

  public SiglusMovementDateLimitController(MovementDateValidator movementDateValidator) {
  ...
  public LocalDate getMovementStartDate(
    ...
    return movementDateValidator.getMovementStartDate(currentDate, facilityId);
  }
}
