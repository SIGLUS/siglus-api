...
@Validated
public class SiglusReportAccessRecordController {

  @Autowired
  private SiglusReportAccessRecordService siglusReportAccessRecordService;

  @PostMapping
  public void accessRecord(@RequestParam @NotNull @Valid ReportNameEnum reportName) {
    siglusReportAccessRecordService.accessRecord(reportName);
  }
}
