...
(
    select
        ...
        case
            ...
            when rtcli.service = 'HF'
                and rtcli.outcome = 'unjustified' then 'Adulto-MR Indução'
            when rtcli.service = 'HF'
                and rtcli.outcome = 'newColumn4' then 'Adulto-MR Intensiva'
            when rtcli.service = 'HF'
            ...
            when rtcli.service = 'total'
                and rtcli.outcome = 'unjustified' then 'Pediatrico-MR Indução'
            when rtcli.service = 'total'
                and rtcli.outcome = 'newColumn4' then 'Pediatrico-MR Intensiva'
            when rtcli.service = 'total'
