...
select
    provincename, provincefacilitycode, districtname, districtfacilitycode, facilityname, facilitycode, programname, productcode, productname, lotcode, expirationdate, stockonhand, sum(amountremoved) as amountremoved, priceperpack, sum(totalprice) as totalprice, removeddate
from
    (
        SELECT
            CASE
...
GROUP BY provincename, provincefacilitycode, districtname, districtfacilitycode, facilityname, facilitycode, programname, productcode, productname, lotcode, expirationdate, stockonhand, removeddate, priceperpack;
