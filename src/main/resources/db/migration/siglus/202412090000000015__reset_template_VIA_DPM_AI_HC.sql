-- VIA Template - DPM/AI/HC
SET local vars.template = 'VIA Template - DPM/AI/HC';
SET local vars.templateid = '83e3f7d0-6519-42de-a36a-2dd96ac9f405';
...
('2a23e900-22f1-11ef-9e35-acde48001122',current_setting('vars.programid')::uuid,current_setting('vars.templateid')::uuid,(SELECT id FROM referencedata.facility_types ft WHERE ft.code = 'DPM')),
('2a23e964-22f1-11ef-9e35-acde48001122',current_setting('vars.programid')::uuid,current_setting('vars.templateid')::uuid,(SELECT id FROM referencedata.facility_types ft WHERE ft.code = 'AI')),
('2a23e9c8-22f1-11ef-9e35-acde48001122',current_setting('vars.programid')::uuid,current_setting('vars.templateid')::uuid,(SELECT id FROM referencedata.facility_types ft WHERE ft.code = 'HC'));
...
('2a23c344-22f1-11ef-9e35-acde48001122',current_setting('vars.templateid')::uuid,TRUE,TRUE,TRUE,FALSE,FALSE,FALSE,FALSE,TRUE,FALSE);
...
('e4218fb8-649f-11ed-9999-acde48001122','CONSULTATIONNUMBER',0,'Consultation Number','number','bcd979a4-1967-4258-a5be-b04f82c4c62c',current_setting('vars.templateid')::uuid),
('e421931e-649f-11ed-9999-acde48001122','KITUSAGE',0,'KIT data collection','collection','bce979a4-1957-4259-a5bb-b04f86c4c72c',current_setting('vars.templateid')::uuid),
('e421940e-649f-11ed-9999-acde48001122','KITUSAGE',1,'Services','service','bce979a4-1957-4259-a5bb-b04f86c4c72a',current_setting('vars.templateid')::uuid),
('e42194b8-649f-11ed-9999-acde48001122','PATIENT',0,'Type of Patient','patientType','bbf232b4-4b07-4a8e-a22c-1607995b01cd',current_setting('vars.templateid')::uuid),
('e421954e-649f-11ed-9999-acde48001122','RAPIDTESTCONSUMPTION',0,'Test Project','project','97230a23-f47b-4115-86fc-f91760b7b439',current_setting('vars.templateid')::uuid),
('e42195e4-649f-11ed-9999-acde48001122','RAPIDTESTCONSUMPTION',1,'Test Outcome','outcome','0d3b5adc-e767-49a1-8ed7-7b2a92f82d7f',current_setting('vars.templateid')::uuid),
('e421965c-649f-11ed-9999-acde48001122','RAPIDTESTCONSUMPTION',2,'Services','service','bce979a4-1957-4259-a5bb-b04f86c4c72a',current_setting('vars.templateid')::uuid),
('e42196ca-649f-11ed-9999-acde48001122','REGIMEN',0,'Regimen','regimen','91deacfc-1f06-4052-a7d2-0c78a1642043',current_setting('vars.templateid')::uuid),
('e4219724-649f-11ed-9999-acde48001122','REGIMEN',1,'Summary','summary','e2cd8d9e-22e9-4ea4-a61c-e3bd603d02cb',current_setting('vars.templateid')::uuid),
('e421977e-649f-11ed-9999-acde48001122','USAGEINFORMATION',0,'Product Usage Information','information','bce979a4-1876-4259-9102-b04f86c4c72c',current_setting('vars.templateid')::uuid),
('e42197e2-649f-11ed-9999-acde48001122','USAGEINFORMATION',1,'Services','service','bce979a4-1957-4259-a5bb-b04f86c4c72a',current_setting('vars.templateid')::uuid);
...
('2a23c39e-22f1-11ef-9e35-acde48001122','e421931e-649f-11ed-9999-acde48001122',0,'KD',TRUE,'No. de Kits Recebidos','kitReceived','record the quantity of how many KIT received','STOCK_CARDS','received','USER_INPUT|STOCK_CARDS','23c0ecc1-f58e-41e4-99f2-241a3f8360d6',current_setting('vars.templateid')::uuid),
('2a23c3f8-22f1-11ef-9e35-acde48001122','e421931e-649f-11ed-9999-acde48001122',1,'KD',TRUE,'No. de Kits abertos','kitOpened','record the quantity of how many KIT opened','STOCK_CARDS','consumed','USER_INPUT|STOCK_CARDS','86ca8cea-94c2-4d50-8dc8-ec5f6ff60ec4',current_setting('vars.templateid')::uuid),
('2a23c452-22f1-11ef-9e35-acde48001122','e421965c-649f-11ed-9999-acde48001122',0,'SV',TRUE,'HF','HF','record the test outcome for my facility','USER_INPUT',NULL,'USER_INPUT','c280a232-a39e-4ea9-850b-7bb9fcc2d848',current_setting('vars.templateid')::uuid),
('2a23c4b6-22f1-11ef-9e35-acde48001122','e421965c-649f-11ed-9999-acde48001122',1,'SV',TRUE,'Total','total','record the total number of each column','USER_INPUT',NULL,'USER_INPUT|CALCULATED','09e5d451-0ffe-43df-ae00-2f15f2a3681b',current_setting('vars.templateid')::uuid),
('2a23c510-22f1-11ef-9e35-acde48001122','e421965c-649f-11ed-9999-acde48001122',2,'SV',TRUE,'APES','APES','record the related test outcomes for APES','USER_INPUT',NULL,'USER_INPUT','379692a8-12f4-4c35-868a-9b6055c8fa8e',current_setting('vars.templateid')::uuid),
('2a23c56a-22f1-11ef-9e35-acde48001122','e42197e2-649f-11ed-9999-acde48001122',0,'SV',TRUE,'HF','HF','record the product usage information for my facility','USER_INPUT',NULL,'USER_INPUT','cbee99e4-1827-0291-ab4f-783d61ac80a6',current_setting('vars.templateid')::uuid),
('2a23c5ce-22f1-11ef-9e35-acde48001122','e42197e2-649f-11ed-9999-acde48001122',1,'SV',TRUE,'Total','total','record the total number of each column','USER_INPUT',NULL,'USER_INPUT|CALCULATED','95227492-2874-2836-8fa0-dd5b5cef3e8e',current_setting('vars.templateid')::uuid),
('2a23c628-22f1-11ef-9e35-acde48001122','e42194b8-649f-11ed-9999-acde48001122',0,'PD',TRUE,'New','new','record the number of new patients','USER_INPUT',NULL,'USER_INPUT','07a70f2b-451c-401a-b8ca-75e56baeb91c',current_setting('vars.templateid')::uuid),
('2a23c682-22f1-11ef-9e35-acde48001122','e42194b8-649f-11ed-9999-acde48001122',1,'PD',TRUE,'Total','total','record the total number of this group','USER_INPUT',NULL,'USER_INPUT|CALCULATED','f51371a4-ba6f-4119-9a0e-1a588fa5df21',current_setting('vars.templateid')::uuid),
('2a23c6dc-22f1-11ef-9e35-acde48001122','e421954e-649f-11ed-9999-acde48001122',0,'TP',TRUE,'HIV Determine','hivDetermine','record the test data for HIV Determine',NULL,NULL,E'','28cbdef0-318b-4b34-a4c3-9d1b5bb74d15',current_setting('vars.templateid')::uuid),
('2a23c736-22f1-11ef-9e35-acde48001122','e421977e-649f-11ed-9999-acde48001122',0,'PU',TRUE,'N Treatments Attended in this Month','treatmentsAttended','record the quantity of patients for each treatment by products','USER_INPUT',NULL,'USER_INPUT','23c0ecc1-9182-7161-99f2-241a3f8360d6',current_setting('vars.templateid')::uuid),
('2a23c79a-22f1-11ef-9e35-acde48001122','e421977e-649f-11ed-9999-acde48001122',1,'PU',TRUE,'Existent Stock at the End of the Period','existentStock','record the SOH of the product','USER_INPUT',NULL,'USER_INPUT','86ca8cea-9281-9281-8dc8-ec5f6ff60ec4',current_setting('vars.templateid')::uuid),
('2a23c7f4-22f1-11ef-9e35-acde48001122','e4219724-649f-11ed-9999-acde48001122',0,'SU',TRUE,'1st linhas','1stLinhas','display on the second part of the regimen section as the first lines','USER_INPUT',NULL,'USER_INPUT','73a20c66-c0f5-45d3-8268-336198296e33',current_setting('vars.templateid')::uuid),
('2a23c84e-22f1-11ef-9e35-acde48001122','e4219724-649f-11ed-9999-acde48001122',1,'SU',TRUE,'Total','total','Count the total number in the second part of the regimen section','CALCULATED',NULL,'CALCULATED|USER_INPUT','676665ea-ba70-4742-b4d3-c512e7a9f389',current_setting('vars.templateid')::uuid),
('2a23c8a8-22f1-11ef-9e35-acde48001122','e4218fb8-649f-11ed-9999-acde48001122',0,'CN',TRUE,'No.de Consultas Externas Realizadas','consultationNumber','record the number of consultations performed in this period','USER_INPUT',NULL,'USER_INPUT','23c0edc1-9382-7161-99f2-241a3e8360c6',current_setting('vars.templateid')::uuid),
('2a23c90c-22f1-11ef-9e35-acde48001122','e4218fb8-649f-11ed-9999-acde48001122',1,'CN',FALSE,'Total','total','record the total number','USER_INPUT',NULL,'USER_INPUT|CALCULATED','95327492-2874-3836-8fa0-dd2b5ced3e8c',current_setting('vars.templateid')::uuid),
('2a23c966-22f1-11ef-9e35-acde48001122','e42196ca-649f-11ed-9999-acde48001122',0,'RE',TRUE,'Code','code','display the code of each regimen','REFERENCE_DATA',NULL,'REFERENCE_DATA','c47396fe-381a-49a2-887e-ce25c80b0875',current_setting('vars.templateid')::uuid),
('2a23c9c0-22f1-11ef-9e35-acde48001122','e42196ca-649f-11ed-9999-acde48001122',1,'RE',TRUE,'Therapeutic regiment','regiment','display the name of each regimen','REFERENCE_DATA',NULL,'REFERENCE_DATA','55353f84-d5a1-4a60-985e-ec3c04212575',current_setting('vars.templateid')::uuid),
('2a23ca24-22f1-11ef-9e35-acde48001122','e42196ca-649f-11ed-9999-acde48001122',2,'RE',TRUE,'Total patients','patients','record the number of patients','USER_INPUT',NULL,'USER_INPUT','1a44bc23-b652-4a72-b74b-98210d44101c',current_setting('vars.templateid')::uuid),
('2a23ca7e-22f1-11ef-9e35-acde48001122','e42196ca-649f-11ed-9999-acde48001122',3,'RE',TRUE,'Community pharmacy','community','record the number of patients in community pharmacy','USER_INPUT',NULL,'USER_INPUT','04065445-3aaf-4928-b329-8454964b62f8',current_setting('vars.templateid')::uuid),
('2a23cae2-22f1-11ef-9e35-acde48001122','e421940e-649f-11ed-9999-acde48001122',0,'SV',TRUE,'US','HF','record the quantity of KIT data in my facility',NULL,NULL,E'','cbee99e4-f100-4f9e-ab4f-783d61ac80a6',current_setting('vars.templateid')::uuid),
('2a23cb5a-22f1-11ef-9e35-acde48001122','e421940e-649f-11ed-9999-acde48001122',1,'SV',TRUE,'APE','CHW','record the quantity of KIT data in CHW','USER_INPUT',NULL,'USER_INPUT','95227492-c394-4f7e-8fa0-dd5b5cef3e8e',current_setting('vars.templateid')::uuid),
('2a23cbfa-22f1-11ef-9e35-acde48001122','e42195e4-649f-11ed-9999-acde48001122',0,'TO',TRUE,'Consumo','consumo','record the consumo quantity for each test project','USER_INPUT',NULL,'USER_INPUT','743a0575-6d00-4ff0-89a6-1a76de1c1714',current_setting('vars.templateid')::uuid),
('2a23cc9a-22f1-11ef-9e35-acde48001122','e42195e4-649f-11ed-9999-acde48001122',1,'TO',TRUE,'Positive','positive','record the positive test outcome quantity for each test project','USER_INPUT',NULL,'USER_INPUT','becae41f-1436-4f67-87ac-dece0b97d417',current_setting('vars.templateid')::uuid),
('2a23cd44-22f1-11ef-9e35-acde48001122','e42195e4-649f-11ed-9999-acde48001122',2,'TO',TRUE,'Unjustified','unjustified','record the unjustified test outcome quantity for each test project','USER_INPUT',NULL,'USER_INPUT','fe6e0f40-f47b-41e2-be57-8064876d75f6',current_setting('vars.templateid')::uuid);
