-- Malaria Template - HC
SET local vars.template = 'Malaria Template - HC';
SET local vars.templateid = 'effd36a5-d65f-4f84-ae28-a5d669afd6cb';
...
INSERT INTO requisition.requisition_template_assignments(id,programid,templateid,facilitytypeid)
    SELECT '2a229ae6-22f1-11ef-9e35-acde48001122',current_setting('vars.programid')::uuid,current_setting('vars.templateid')::uuid,id
...
('2a229b4a-22f1-11ef-9e35-acde48001122',current_setting('vars.templateid')::uuid,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,TRUE,TRUE,FALSE);
...
('e5bb2110-708c-11ed-a4c1-acde48001122','AGEGROUP','group','Faixas Etarias',0,'43fa95ae-fcfb-11ec-b939-0242ac120002',current_setting('vars.templateid')::uuid),
('e5bb230e-708c-11ed-a4c1-acde48001122','AGEGROUP','service','Services',1,'bce979a4-1957-4259-a5bb-b04f86c4c72a',current_setting('vars.templateid')::uuid),
('e5bb2390-708c-11ed-a4c1-acde48001122','CONSULTATIONNUMBER','number','Consultation Number',0,'bcd979a4-1967-4258-a5be-b04f82c4c62c',current_setting('vars.templateid')::uuid),
('e5bb23e0-708c-11ed-a4c1-acde48001122','KITUSAGE','service','Services',1,'bce979a4-1957-4259-a5bb-b04f86c4c72a',current_setting('vars.templateid')::uuid),
('e5bb2426-708c-11ed-a4c1-acde48001122','KITUSAGE','collection','KIT data collection',0,'bce979a4-1957-4259-a5bb-b04f86c4c72c',current_setting('vars.templateid')::uuid),
('e5bb246c-708c-11ed-a4c1-acde48001122','PATIENT','patientType','Type of Patient',0,'bbf232b4-4b07-4a8e-a22c-1607995b01cd',current_setting('vars.templateid')::uuid),
('e5bb24b2-708c-11ed-a4c1-acde48001122','RAPIDTESTCONSUMPTION','outcome','Test Outcome',1,'0d3b5adc-e767-49a1-8ed7-7b2a92f82d7f',current_setting('vars.templateid')::uuid),
('e5bb24ee-708c-11ed-a4c1-acde48001122','RAPIDTESTCONSUMPTION','service','Services',2,'bce979a4-1957-4259-a5bb-b04f86c4c72a',current_setting('vars.templateid')::uuid),
('e5bb2534-708c-11ed-a4c1-acde48001122','RAPIDTESTCONSUMPTION','project','Test Project',0,'97230a23-f47b-4115-86fc-f91760b7b439',current_setting('vars.templateid')::uuid),
('e5bb2570-708c-11ed-a4c1-acde48001122','REGIMEN','summary','Summary',1,'e2cd8d9e-22e9-4ea4-a61c-e3bd603d02cb',current_setting('vars.templateid')::uuid),
('e5bb25b6-708c-11ed-a4c1-acde48001122','REGIMEN','regimen','Regimen',0,'91deacfc-1f06-4052-a7d2-0c78a1642043',current_setting('vars.templateid')::uuid),
('e5bb25fc-708c-11ed-a4c1-acde48001122','USAGEINFORMATION','information','Product Usage Information',0,'bce979a4-1876-4259-9102-b04f86c4c72c',current_setting('vars.templateid')::uuid),
('e5bb2638-708c-11ed-a4c1-acde48001122','USAGEINFORMATION','service','Services',1,'bce979a4-1957-4259-a5bb-b04f86c4c72a',current_setting('vars.templateid')::uuid);
...
('2a229ba4-22f1-11ef-9e35-acde48001122','e5bb25fc-708c-11ed-a4c1-acde48001122',0,'PU',TRUE,'Nº Tratamentos Aviados no Mês','treatmentsAttended','record the quantity of patients for each treatment by products','USER_INPUT',NULL,'USER_INPUT','23c0ecc1-9182-7161-99f2-241a3f8360d6',current_setting('vars.templateid')::uuid),
('2a229c08-22f1-11ef-9e35-acde48001122','e5bb25fc-708c-11ed-a4c1-acde48001122',1,'PU',TRUE,'Stock Existente no Fim do período','existentStock','record the SOH of the product','USER_INPUT',NULL,'USER_INPUT','86ca8cea-9281-9281-8dc8-ec5f6ff60ec4',current_setting('vars.templateid')::uuid),
('2a229c94-22f1-11ef-9e35-acde48001122','e5bb2638-708c-11ed-a4c1-acde48001122',0,'SV',TRUE,'US','HF','record the product usage information for my facility','USER_INPUT',NULL,'USER_INPUT','cbee99e4-1827-0291-ab4f-783d61ac80a6',current_setting('vars.templateid')::uuid),
('2a229d3e-22f1-11ef-9e35-acde48001122','e5bb2638-708c-11ed-a4c1-acde48001122',1,'N',TRUE,'APE','newColumn0','CHW','USER_INPUT',NULL,'USER_INPUT',NULL,current_setting('vars.templateid')::uuid),
('2a229e88-22f1-11ef-9e35-acde48001122','e5bb2638-708c-11ed-a4c1-acde48001122',2,'SV',TRUE,'Total','total','record the total number of each column','CALCULATED',NULL,'USER_INPUT|CALCULATED','95227492-2874-2836-8fa0-dd5b5cef3e8e',current_setting('vars.templateid')::uuid),
('2a22a158-22f1-11ef-9e35-acde48001122','e5bb23e0-708c-11ed-a4c1-acde48001122',0,'SV',TRUE,'HF','HF','record the quantity of KIT data in my facility',NULL,NULL,E'','cbee99e4-f100-4f9e-ab4f-783d61ac80a6',current_setting('vars.templateid')::uuid),
('2a22a22a-22f1-11ef-9e35-acde48001122','e5bb23e0-708c-11ed-a4c1-acde48001122',1,'SV',TRUE,'CHW','CHW','record the quantity of KIT data in CHW','USER_INPUT',NULL,'USER_INPUT','95227492-c394-4f7e-8fa0-dd5b5cef3e8e',current_setting('vars.templateid')::uuid),
('2a22a298-22f1-11ef-9e35-acde48001122','e5bb24b2-708c-11ed-a4c1-acde48001122',0,'TO',TRUE,'Consumo','consumo','record the consumo quantity for each test project','USER_INPUT',NULL,'USER_INPUT','743a0575-6d00-4ff0-89a6-1a76de1c1714',current_setting('vars.templateid')::uuid),
('2a22a306-22f1-11ef-9e35-acde48001122','e5bb24b2-708c-11ed-a4c1-acde48001122',1,'TO',TRUE,'Positive','positive','record the positive test outcome quantity for each test project','USER_INPUT',NULL,'USER_INPUT','becae41f-1436-4f67-87ac-dece0b97d417',current_setting('vars.templateid')::uuid),
('2a22a4be-22f1-11ef-9e35-acde48001122','e5bb24b2-708c-11ed-a4c1-acde48001122',2,'TO',TRUE,'Unjustified','unjustified','record the unjustified test outcome quantity for each test project','USER_INPUT',NULL,'USER_INPUT','fe6e0f40-f47b-41e2-be57-8064876d75f6',current_setting('vars.templateid')::uuid),
('2a22a702-22f1-11ef-9e35-acde48001122','e5bb2426-708c-11ed-a4c1-acde48001122',0,'KD',TRUE,'No. of Kit Received','kitReceived','record the quantity of how many KIT received','USER_INPUT',NULL,'USER_INPUT|STOCK_CARDS','23c0ecc1-f58e-41e4-99f2-241a3f8360d6',current_setting('vars.templateid')::uuid),
('2a22a7d4-22f1-11ef-9e35-acde48001122','e5bb2426-708c-11ed-a4c1-acde48001122',1,'KD',TRUE,'No. of Kit Opened','kitOpened','record the quantity of how many KIT opened','USER_INPUT',NULL,'USER_INPUT|STOCK_CARDS','86ca8cea-94c2-4d50-8dc8-ec5f6ff60ec4',current_setting('vars.templateid')::uuid),
('2a22a842-22f1-11ef-9e35-acde48001122','e5bb2110-708c-11ed-a4c1-acde48001122',0,'PU',TRUE,'Tratamento','treatment','record the quantity of patients for each age group in treatment','USER_INPUT',NULL,'USER_INPUT','9a384fee-fcfe-11ec-b939-0242ac120002',current_setting('vars.templateid')::uuid),
('2a22a8a6-22f1-11ef-9e35-acde48001122','e5bb2110-708c-11ed-a4c1-acde48001122',1,'PU',TRUE,'Profilaxia','prophylaxis','record the quantity of patients for each age group in prophylaxis','USER_INPUT',NULL,'USER_INPUT','a4d2a594-fcfe-11ec-b939-0242ac120002',current_setting('vars.templateid')::uuid),
('2a22a90a-22f1-11ef-9e35-acde48001122','e5bb2390-708c-11ed-a4c1-acde48001122',0,'CN',TRUE,'No.of External Consultations Performed','consultationNumber','record the number of consultations performed in this period','USER_INPUT',NULL,'USER_INPUT','23c0edc1-9382-7161-99f2-241a3e8360c6',current_setting('vars.templateid')::uuid),
('2a22a964-22f1-11ef-9e35-acde48001122','e5bb2390-708c-11ed-a4c1-acde48001122',1,'CN',FALSE,'Total','total','record the total number','USER_INPUT',NULL,'USER_INPUT|CALCULATED','95327492-2874-3836-8fa0-dd2b5ced3e8c',current_setting('vars.templateid')::uuid),
('2a22a9c8-22f1-11ef-9e35-acde48001122','e5bb230e-708c-11ed-a4c1-acde48001122',0,'SV',TRUE,'Adultos','adultos','Adults','USER_INPUT',NULL,'USER_INPUT','13263196-fcff-11ec-b939-0242ac120002',current_setting('vars.templateid')::uuid),
('2a22aa22-22f1-11ef-9e35-acde48001122','e5bb230e-708c-11ed-a4c1-acde48001122',1,'SV',TRUE,'Criança < 25Kg','criança < 25Kg','Child < 25 kg','USER_INPUT',NULL,'USER_INPUT','1326342a-fcff-11ec-b939-0242ac120002',current_setting('vars.templateid')::uuid),
('2a22aa86-22f1-11ef-9e35-acde48001122','e5bb230e-708c-11ed-a4c1-acde48001122',2,'SV',TRUE,'Criança > 25Kg','criança > 25Kg','Child > 25 kg','USER_INPUT',NULL,'USER_INPUT','c1092b36-fd01-11ec-b939-0242ac120002',current_setting('vars.templateid')::uuid),
('2a22aaf4-22f1-11ef-9e35-acde48001122','e5bb2570-708c-11ed-a4c1-acde48001122',0,'SU',TRUE,'1st linhas','1stLinhas','display on the second part of the regimen section as the first lines','USER_INPUT',NULL,'USER_INPUT','73a20c66-c0f5-45d3-8268-336198296e33',current_setting('vars.templateid')::uuid),
('2a22ab58-22f1-11ef-9e35-acde48001122','e5bb2570-708c-11ed-a4c1-acde48001122',1,'SU',TRUE,'Total','total','Count the total number in the second part of the regimen section','CALCULATED',NULL,'CALCULATED|USER_INPUT','676665ea-ba70-4742-b4d3-c512e7a9f389',current_setting('vars.templateid')::uuid),
('2a22abb2-22f1-11ef-9e35-acde48001122','e5bb24ee-708c-11ed-a4c1-acde48001122',0,'SV',TRUE,'HF','HF','record the test outcome for my facility','USER_INPUT',NULL,'USER_INPUT','c280a232-a39e-4ea9-850b-7bb9fcc2d848',current_setting('vars.templateid')::uuid),
('2a22ac0c-22f1-11ef-9e35-acde48001122','e5bb24ee-708c-11ed-a4c1-acde48001122',1,'SV',TRUE,'Total','total','record the total number of each column','USER_INPUT',NULL,'USER_INPUT|CALCULATED','09e5d451-0ffe-43df-ae00-2f15f2a3681b',current_setting('vars.templateid')::uuid),
('2a22ac66-22f1-11ef-9e35-acde48001122','e5bb24ee-708c-11ed-a4c1-acde48001122',2,'SV',TRUE,'APES','APES','record the related test outcomes for APES','USER_INPUT',NULL,'USER_INPUT','379692a8-12f4-4c35-868a-9b6055c8fa8e',current_setting('vars.templateid')::uuid),
('2a22acca-22f1-11ef-9e35-acde48001122','e5bb2534-708c-11ed-a4c1-acde48001122',0,'TP',TRUE,'HIV Determine','hivDetermine','record the test data for HIV Determine',NULL,NULL,E'','28cbdef0-318b-4b34-a4c3-9d1b5bb74d15',current_setting('vars.templateid')::uuid),
('2a22ad24-22f1-11ef-9e35-acde48001122','e5bb246c-708c-11ed-a4c1-acde48001122',0,'PD',TRUE,'New','new','record the number of new patients','USER_INPUT',NULL,'USER_INPUT','07a70f2b-451c-401a-b8ca-75e56baeb91c',current_setting('vars.templateid')::uuid),
('2a22ad7e-22f1-11ef-9e35-acde48001122','e5bb246c-708c-11ed-a4c1-acde48001122',1,'PD',TRUE,'Total','total','record the total number of this group','USER_INPUT',NULL,'USER_INPUT|CALCULATED','f51371a4-ba6f-4119-9a0e-1a588fa5df21',current_setting('vars.templateid')::uuid),
('2a22ade2-22f1-11ef-9e35-acde48001122','e5bb25b6-708c-11ed-a4c1-acde48001122',0,'RE',TRUE,'Code','code','display the code of each regimen','REFERENCE_DATA',NULL,'REFERENCE_DATA','c47396fe-381a-49a2-887e-ce25c80b0875',current_setting('vars.templateid')::uuid),
('2a22ae50-22f1-11ef-9e35-acde48001122','e5bb25b6-708c-11ed-a4c1-acde48001122',1,'RE',TRUE,'Therapeutic regiment','regiment','display the name of each regimen','REFERENCE_DATA',NULL,'REFERENCE_DATA','55353f84-d5a1-4a60-985e-ec3c04212575',current_setting('vars.templateid')::uuid),
('2a22aeb4-22f1-11ef-9e35-acde48001122','e5bb25b6-708c-11ed-a4c1-acde48001122',2,'RE',TRUE,'Total patients','patients','record the number of patients','USER_INPUT',NULL,'USER_INPUT','1a44bc23-b652-4a72-b74b-98210d44101c',current_setting('vars.templateid')::uuid),
('2a22af0e-22f1-11ef-9e35-acde48001122','e5bb25b6-708c-11ed-a4c1-acde48001122',3,'RE',TRUE,'Community pharmacy','community','record the number of patients in community pharmacy','USER_INPUT',NULL,'USER_INPUT','04065445-3aaf-4928-b329-8454964b62f8',current_setting('vars.templateid')::uuid);
