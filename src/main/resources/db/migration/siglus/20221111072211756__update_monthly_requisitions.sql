...
CREATE VIEW dashboard.vw_monthly_requisitions
            (id, programid, processingperiodid, processingperiodname, district, province, requisitionperiod,
             facilityname, ficilitycode, inventorydate, statusdetail, submittedstatus,
...
SELECT id,
       ...
       submitstartdate,
       submitenddate
FROM dashboard.not_submitted_monthly_requisitions;
