...
select
    ...
    case
        ...
        when pli.groupname = 'newSection3'
            and pli.columnname = 'newColumn5' then 'Adulto-XR Intensiva'
        ...
        when pli.groupname = 'newSection4'
            and pli.columnname = 'newColumn3' then 'Pediatrico-XR Indução'
        when pli.groupname = 'newSection4'
            and pli.columnname = 'newColumn4' then 'Pediatrico-XR Manutenção'
        when pli.groupname = 'newSection4'
            and pli.columnname = 'newColumn5' then 'Pediatrico-XR Intensiva'
        end as regimen,
    p.name as program,
