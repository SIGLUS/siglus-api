...
select
    provincename, provincefacilitycode, districtname, districtfacilitycode, facilityname, facilitycode, programname, productcode, productname, lotcode, expirationdate, sum(amountremoved) as amountremoved, sum(totalprice) as totalprice, removeddate
from
    (
        SELECT
            CASE
