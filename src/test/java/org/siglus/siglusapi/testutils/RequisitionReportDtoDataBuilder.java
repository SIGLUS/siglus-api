...
public class RequisitionReportDtoDataBuilder implements DtoDataBuilder<RequisitionReportDto> {
  ...
  public RequisitionReportDtoDataBuilder() {
    ...
    initiatedBy = new org.siglus.siglusapi.testutils.UserDtoDataBuilder().buildAsDto();
    initiatedDate = ZonedDateTime.now().minusMonths(1);
    submittedBy = new org.siglus.siglusapi.testutils.UserDtoDataBuilder().buildAsDto();
    submittedDate = ZonedDateTime.now().minusDays(2);
    authorizedBy = new org.siglus.siglusapi.testutils.UserDtoDataBuilder().buildAsDto();
