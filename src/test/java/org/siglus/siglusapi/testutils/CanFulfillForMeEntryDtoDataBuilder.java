...
public class CanFulfillForMeEntryDtoDataBuilder {
  ...
  public CanFulfillForMeEntryDtoDataBuilder() {
    stockCard = new org.siglus.siglusapi.testutils.ObjectReferenceDtoDataBuilder().withPath("api/stockCards").build();
    orderable = new org.siglus.siglusapi.testutils.ObjectReferenceDtoDataBuilder().withPath("api/orderables").build();
    lot = new org.siglus.siglusapi.testutils.ObjectReferenceDtoDataBuilder().withPath("api/lots").build();
    stockOnHand = 10;
