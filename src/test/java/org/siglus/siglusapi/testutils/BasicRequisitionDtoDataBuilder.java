...
public class BasicRequisitionDtoDataBuilder implements DtoDataBuilder<BasicRequisitionDto> {
  ...
  public BasicRequisitionDtoDataBuilder() {
    ...
    processingPeriod = new org.siglus.siglusapi.testutils.BasicProcessingPeriodDtoDataBuilder().buildAsDto();
    facility = new org.siglus.siglusapi.testutils.MinimalFacilityDtoDataBuilder().buildAsDto();
