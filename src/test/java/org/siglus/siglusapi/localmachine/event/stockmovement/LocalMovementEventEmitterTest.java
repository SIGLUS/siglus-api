...
public class LocalMovementEventEmitterTest {

  @InjectMocks
  private LocalMovementEventEmitter emitter;
  ...
  public void shouldEmitSuccessfully() {
    // given
    when(cdcRecordMapper.buildEvents(anyList())).thenReturn(Lists.newArrayList());
