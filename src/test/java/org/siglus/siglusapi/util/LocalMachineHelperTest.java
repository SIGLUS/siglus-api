...
public class LocalMachineHelperTest {
  ...
  public void shouldReturnFalseIfFacilityExtensionNotConfigured() {
    ...
    // when
    boolean isLocalMachine = localMachineHelper.isLocalMachine();

    // then
    assertFalse(isLocalMachine);
  }

  @Test
  public void shouldReturnFalseIfFacilityIsNotLocalMachine() {
    // given
  ...
  @Test
  public void shouldReturnTrueIfFacilityIsLocalMachine() {
    // given
    FacilityExtension facilityExtension = FacilityExtension.builder()
        .facilityId(facilityId)
        .isLocalMachine(true)
