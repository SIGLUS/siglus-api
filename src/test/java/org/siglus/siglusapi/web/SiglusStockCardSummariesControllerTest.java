...
public class SiglusStockCardSummariesControllerTest {
  ...
  public void shouldCallServiceWhenGetStockCardDetailsDtos() {
    controller.getStockCardSummaryDtos(parameters, Collections.emptyList(), draftId, null, pageable);

    verify(service).getStockCardSummaryDtos(parameters, Collections.emptyList(), draftId, pageable, null);
  }
