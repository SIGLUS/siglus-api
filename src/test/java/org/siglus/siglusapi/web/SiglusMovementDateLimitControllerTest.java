...
public class SiglusMovementDateLimitControllerTest {

  @InjectMocks
  private SiglusMovementDateLimitController controller;

  @Mock
  private MovementDateValidator service;
  ...
  public void shouldCallServiceWhenGetMovementStartDate() {
    ...
    // then
    verify(service).getMovementStartDate(any(), any());
  }
}
