...
import org.openlmis.requisition.interceptor.RequisitionMvcInterceptor;
...
@Configuration
@EnableCaching
public class RequisitionCustomWebMvcConfigurerAdapter extends WebMvcConfigurerAdapter {

  @Value("${service.url}")
  private String serviceUrl;

  @Autowired
  private RequisitionMvcInterceptor mvcInterceptor;
